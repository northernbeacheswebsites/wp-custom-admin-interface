        ...
        <td scope="row" colspan="2">
            ...
            <div id="accordion" style="margin-top:-25px;">
                ...
                <div>
                    ...
                    echo '<a id="export-options-select-all" class="options-select-all" href="#">Select all</a> / <a id="export-options-deselect-all" class="options-deselect-all" href="#">Deselect all</a>';
                ...
                <div>
                    <?php
                        echo '<a id="delete-options-select-all" class="options-select-all" href="#">Select all</a> / <a id="delete-options-deselect-all" class="options-deselect-all" href="#">Deselect all</a>';
...
function wp_custom_admin_interface_help_callback(){
    ...
    <div id="accordion">
        ...
        <div>
            <p><?php _e('Please use the', 'wp-custom-admin-interface' ); ?> <a target="_blank" href="https://wordpress.org/support/plugin/wp-custom-admin-interface">WordPress <?php _e('forum', 'wp-custom-admin-interface' ); ?></a> <?php _e('to raise a support issue for the plugin. I do test this plugin so if you are experiencing an issue I probably can\'t repeat it from my end. This means there\'s something different about your WordPress environment. Therefore in your support request can you please include the diagnostic information provided in the below diagnostics tab. Also this plugin is pretty javascript intensive and sometimes browsers cache these files. So PLEASE clear your cache before reporting an issue. I generally respond to these within 24 hours during weekdays. Currently it\'s', 'wp-custom-admin-interface' ); ?> <?php echo $date->format('g:iA').' on '.  $date->format('l'); ?> <?php _e('down under! Also check out the below walkthrough video:', 'wp-custom-admin-interface' ); ?></p>
...
function wp_custom_admin_interface_top_level_menu_render() { 
    ...
    */
    ...
    <tr valign="top">
        <td scope="row" colspan="2">
            <div class="notice notice-info inline" >
                <p><i class="fa fa-info-circle information-icon" aria-hidden="true"></i> <?php _e( 'Modify the main menu of WordPress.', 'wp-custom-admin-interface' ); ?></p>
            </div>    
    ...
    <tr valign="top">
        <td scope="row" colspan="2">
            ...
            <div id="admin-toolbar-manager-buttons" style="margin-bottom: 30px;">
                ...
                <button id="restore-default-toolbar" class="button-secondary" style="cursor:pointer;" toolbardata="<?php echo base64_encode(json_encode($wp_custom_admin_interface_all_toolbar_items)); ?>"><i class="fa fa-window-restore" aria-hidden="true"></i> <?php _e('Restore to default WordPress Toolbar', 'wp-custom-admin-interface' ); ?></button>
                
                <button id="restore-last-save-toolbar" class="button-secondary" style="cursor:pointer;" toolbardata="<?php echo $options['wp_custom_admin_interface_primary_toolbar_menu']; ?>" removeditems="<?php echo $options['wp_custom_admin_interface_remove_toolbar_item']; ?>"><i class="fa fa-window-restore" aria-hidden="true"></i> <?php _e('Restore to last save', 'wp-custom-admin-interface' ); ?></button>
