...
*       Copyright: ©2017 Northern Beaches Websites.
...
function wp_custom_admin_interface_subpage_menu_generator($menuName) {
    ...
    $wp_custom_admin_interface_settings_page = add_submenu_page('wp_custom_admin_interface',$menuName,$menuName,'manage_options','wpcai_'.$lowercaseAndUnderScored,create_function( null, 'wp_custom_admin_interface_settings_page_content("'.$removeSpaces.'");' ));
    ...
    <table class="form-table">       
        ...
        ?>
            ...
            <a id="plugin-ad" class="please-hide-that-annoying-notice" target="_blank" href="https://northernbeacheswebsites.com.au/contact/">
                <div style="border-radius: 4px; width: 100%; background-color: white; margin-bottom: 20px;">
                    <div style="padding: 0px 25px; text-align: center;">
                        <img style="vertical-align: middle; max-width: 100%; height: auto;" src="<?php echo plugins_url( '/inc/images/development-ad.jpg', __FILE__ ); ?>">
                    </div>
                </div>
            </a>
...
function wp_custom_admin_interface_register_admin($hook)
{
    ...
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_custom_code'){
        ...
        wp_enqueue_script( 'code-mirror-initialisation', plugins_url( '/inc/options/options-page-custom-code.min.js', __FILE__ ), array('jquery'));
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_custom_code_frontend'){
        //initialise codemirror on the page
        wp_enqueue_script( 'code-mirror-initialisation', plugins_url( '/inc/options/options-page-custom-code-frontend.min.js', __FILE__ ), array('jquery'));
    }
    ...
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_manage_settings'){
        ...
        wp_enqueue_script( 'manage-settings', plugins_url( '/inc/options/options-page-manage-settings.min.js', __FILE__ ), array('jquery'));    
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_help'){
        wp_enqueue_script('jquery-ui-accordion');   
        wp_enqueue_script( 'help', plugins_url( '/inc/options/options-page-help.min.js', __FILE__ ), array('jquery'));   
    }
    ...
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_admin_menu'){
        ...
        wp_enqueue_script('menu-page', plugins_url( '/inc/options/options-page-admin-menu.min.js', __FILE__ ), array('jquery')); 
    }
    ...
    if('admin.php' == $pagenow && isset($_GET['page']) && ($_GET['page'] == 'wpcai_maintenance_page'|| $_GET['page'] == 'wpcai_admin_notice') ){
        ...
        wp_enqueue_script( 'maintenance-page', plugins_url( '/inc/options/options-page-maintenance-page.min.js', __FILE__ ), array('jquery'));  
    }
    ...
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_hide_plugins'){
        wp_enqueue_script('hide-plugins', plugins_url( '/inc/options/options-page-hide-plugins.min.js', __FILE__ ), array('jquery')); 
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_hide_sidebars'){
        wp_enqueue_script('hide-sidebars', plugins_url( '/inc/options/options-page-hide-sidebars.min.js', __FILE__ ), array('jquery')); 
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_hide_users'){
        wp_enqueue_script('hide-users', plugins_url( '/inc/options/options-page-hide-users.min.js', __FILE__ ), array('jquery')); 
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_admin_toolbar'){
        wp_enqueue_script('admin-toolbar', plugins_url( '/inc/options/options-page-admin-toolbar.min.js', __FILE__ ), array('jquery')); 
    }
    
    if('admin.php' == $pagenow && isset($_GET['page']) && $_GET['page'] == 'wpcai_hide_meta'){
        wp_enqueue_script('hide-meta', plugins_url( '/inc/options/options-page-hide-meta.min.js', __FILE__ ), array('jquery')); 
    }
    
    if(in_array($hook, $wp_custom_admin_interface_settings_pages) && ($_GET['page'] !== 'wpcai_admin_toolbar' || $_GET['page'] !== 'wpcai_admin_toolbar')) {
        wp_enqueue_script('generic-save-routine', plugins_url( '/inc/options/options-pre-save-routine-generic.min.js', __FILE__ ), array('jquery'));     
    }
...
add_action( 'admin_bar_menu', 'wp_custom_admin_interface_all_toolbar_nodes', 999 );
/**
* 
*
*
...
function wp_custom_admin_interface_custom_frontend_css() {
    ...
    if(isset($options['wp_custom_admin_interface_deactivate_frontend_code'])){} else {
        ...
        if(strlen($options['wp_custom_admin_interface_custom_frontend_css_code'])>0){  
            ...
            wp_enqueue_style( 'custom-frontend-style', plugins_url( '/inc/frontendstyle.css', __FILE__ ) );    
        ...
        if(strlen($options['wp_custom_admin_interface_custom_frontend_javascript_code'])>0){
            wp_enqueue_script( 'custom-frontend-script', plugins_url( '/inc/frontendscript.js', __FILE__ ), array( 'jquery'));
